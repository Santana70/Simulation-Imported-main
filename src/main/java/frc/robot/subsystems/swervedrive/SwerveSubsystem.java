...
private static final Translation2d HUB_RED =
    new Translation2d(FIELD_LENGTH_METERS - 4.6, 4.0);
...
public double getPoseDistanceToHub() {
  return getPose().getTranslation().getDistance(getHubTarget());
}
...
double poseDistance = pose.getTranslation().getDistance(hub);

SmartDashboard.putNumber("Pose/DistanceToHub", poseDistance);
SmartDashboard.putNumber("Pose/HubX", hub.getX());
SmartDashboard.putNumber("Pose/HubY", hub.getY());
  }
...
//    */
  public Command getAutonomousCommand(String pathName)
  {
    ...
    public void addVisionMeasurement(Pose2d pose, double timestampSec) {
    swerveDrive.addVisionMeasurement(pose, timestampSec);
  }

  public void addVisionMeasurement(Pose2d pose, double timestampSec, Matrix<N3, N1> stdDevs) {
    swerveDrive.addVisionMeasurement(pose, timestampSec, stdDevs);
  }

  public Matrix<N3, N1> getMultiTagStdDevs() {
    return VecBuilder.fill(0.20, 0.20, 999999.0);
  }

  public Matrix<N3, N1> getSingleTagStdDevs() {
    return VecBuilder.fill(0.90, 0.90, 999999.0);
  }
